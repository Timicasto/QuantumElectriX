...
public class NBTHelper {
    ...
    public static int handleDelayedSoundsForStack(ItemStack stack, String nbtKey, Entity ent) {
        ...
        int[] delayedSounds = NBTHelper.getIntArray(stack, "delayedSound_"+nbtKey+"_delay");
        int l = 0;
        for(int i=0; i<delayedSounds.length; i++) {
            --delayedSounds[i];
        ...
        if(l>0) {
            NBTHelper.setIntArray(stack, "delayedSound_"+nbtKey+"_delay", delayedSounds);
        }
        else {
            NBTHelper.remove(stack, "delayedSound_"+nbtKey+"_delay");
            NBTHelper.remove(stack, "delayedSound_"+nbtKey+"_sound");
            NBTHelper.remove(stack, "delayedSound_"+nbtKey+"_volume");
            NBTHelper.remove(stack, "delayedSound_"+nbtKey+"_pitch");
        }
        return l;
    }
