...
public class GuiContainerThermalGenerator extends GuiContainer {
    private static final ResourceLocation TEXTURES = new ResourceLocation(QuantumElectriX.MODID + ":textures/gui/glowstone_generator.png");
    private final InventoryPlayer player;
    private final TileEntityThermalGenerator tileentity;

    public GuiContainerThermalGenerator(InventoryPlayer player, TileEntityThermalGenerator tileentity) {
        super(new ContainerThermalGenerator(player, tileentity));
        this.player = player;
