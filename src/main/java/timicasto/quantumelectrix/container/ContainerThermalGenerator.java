...
public class ContainerThermalGenerator extends Container {
    ...
    public ContainerThermalGenerator(InventoryPlayer player, TileEntityThermalGenerator tileentity)
    {
        ...
        this.addSlotToContainer(new SlotItemHandler(handler, 0, 80, 33){
            ...
            public boolean isItemValid(ItemStack stack) {
                return stack.getItem() == Items.COAL || stack.getItem() == Items.BOOK || stack.getItem() == Item.getItemFromBlock(Blocks.LOG) || stack.getItem() == Item.getItemFromBlock(Blocks.LOG2);
            }
